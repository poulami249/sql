...
select customer.customer_id, customer_first_name, customer_last_name from customer
...
VALUES (10,'Thomass Suferfood Store','Fresh Focussed','Thomas','Rosenthal')
...
select
customer_id, round(sum(quantity*cost_to_customer_per_qty),2) as spend,
strftime ('%m', market_date) as Month,
strftime ('%Y', market_date) as Year
FROM customer_purchases
